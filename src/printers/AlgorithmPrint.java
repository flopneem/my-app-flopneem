...
import algorithms.recursive.Search;
...
public class AlgorithmPrint {
    ...
    public static void checkRecursiveBinarySearch(int[] array){
        ...
        int loc01 = Search.binarySearch(array, 2);
        int loc02 = Search.binarySearch(array, 7);
        int loc03 = Search.binarySearch(array, 9);
